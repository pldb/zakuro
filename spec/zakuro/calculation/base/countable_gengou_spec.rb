...
require File.expand_path('../../../../' \
                         'lib/zakuro/calculation/base/countable_gengou',
                         __dir__)
        ...
        describe '#next_year' do
          ...
          let(:gengou) do
            Zakuro::Japan::Gengou.new(
              name: '元号名',
              both_start_year: Zakuro::Japan::Both::Year.new(japan: japan_year, western: western_year),
